...
const daysLeft = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.differenceInDays)(dueDate, today)

const daysLeftMessage= `${daysLeft} days left until ${(0,date_fns__WEBPACK_IMPORTED_MODULE_4__.format)(dueDate, 'MM/dd/yyyy')}`
